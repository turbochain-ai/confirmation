<template>
  <div>
    ...
    <vxe-table ref="xTable" :data="tableData" :edit-config="{trigger: 'dblclick', mode: 'cell'}">
      ...
      <vxe-table-column field="accountName" title="账户名称" :edit-render="{name: 'input'}" width="150"></vxe-table-column>
      <vxe-table-column field="bankAccount" title="银行账号" :edit-render="{name: 'input'}" width="150"></vxe-table-column>
      ...
      <vxe-table-column field="accountType" title="账户类型" :edit-render="{name: 'input'}" width="150"></vxe-table-column>
      <vxe-table-column field="balance" title="余额" :edit-render="{name: 'input'}" width="150"></vxe-table-column>
      <vxe-table-column field="startAndEndDate" title="起止日期" :edit-render="{name: 'input'}" width="150"></vxe-table-column>
      <vxe-table-column field="limit" title="是否用于担保或存在其他使用限制" :edit-render="{name: 'input'}" width="250"></vxe-table-column>
